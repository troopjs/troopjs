...
return e===j?!1:d===j?!0:new RegExp(g.call(d[3]).map(function(a){return"^"+a}).join("|"),"m").test(e.replace(s,"\n"))},k[n]=d,k[o]=e,k[p]=f}),define("troopjs-jquery/noconflict",["jquery"],function(a){return a.noConflict(!0)}),define("troopjs/version",[],function(){return"2.0.2-7"}),define(["troopjs/version"],function(a){return a});